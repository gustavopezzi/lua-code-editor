...
class Level4IDE extends CustomController {
    function __construct() {
        parent::__construct();
    }

    public function index() {
        $this->data['whiteboard_left_content'] = "<span><img src='".site_url("files/level4/whiteboard-left-ide.png")."'/></span>";
        $this->data['whiteboard_right_content'] = "<span><img src='".site_url("files/level4/whiteboard-right-ide.png")."'/></span>";

        $this->data['page_title'] = 'Level 4 - IDE';
