const EditorActions = require('./editor-actions.js');
...
module.exports = class SpriteEditor {
	main() {
		...
		let cx = 0,
			cy = 0; // top left (pixels)

		// sheet
		let sx = 0,
			sy = 0; // top left (cells)

		const am = new CodeEditorActions(redo, undo, merge);
				...
				children: [
                    {
						...
						h: 8,
						onDraw() {
							sys.text("SPRITE EDITOR", this.x, this.y, 15);
						},
						onPointerDown() {
				...
				children: [
                    {
						...
						h: 12,
						onDraw() {
							sys.char(16, 2 + this.x, 2 + this.y, tool == 'draw' ? 15 : 7);
						},
						onPointerDown() {
							tool = 'draw';
						},
					},
					{
						...
						h: 12,
						onDraw() {
							sys.char(17, 2 + this.x, 2 + this.y, tool == 'fill' ? 15 : 7);
						},
						onPointerDown() {
							tool = 'fill';
						},
	...
	onResume() {
		this.sys.memwrite(
            0x8000,
            ''
        );
	}
